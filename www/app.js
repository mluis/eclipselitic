...
var eclipselitic = angular.module('eclipselitic', ['akoenig.deckgrid']);
var cors_api_url = 'https://cors-anywhere.herokuapp.com/';

// Define the `eclipseliticBodyController` controller on the `eclipselitic` module
eclipselitic.controller('eclipseliticBodyController', function eclipseliticBodyController($scope, $http) {
